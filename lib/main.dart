...
class _MyAppState extends State<MyApp> {
  ...
  static const String _clientId = "e5e62190-81be-4d96-9253-8a29db90c50b";
...
<html>
  <head>
    ...
    <title>Power BI Client - JavaScript</title>
    <base path="/" />
  </head>
  <body>
      ...
      body: Builder(builder: (BuildContext context) {
        return WebView(
          ...
          onWebViewCreated: (WebViewController webViewController) async {
            ...
            String fileText = await rootBundle.loadString('assets/powerbi/embed.html');
